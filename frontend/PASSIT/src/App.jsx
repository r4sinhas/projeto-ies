      ...
      >
        ...
        <ul className="pt-6 ">
          {Menus.map((Menu, index) => (
            <li
              key={index}
              className={`flex justify-between rounded-md p-2 cursor-pointer transition ease-in-out delay-150 bg-green-700 hover:-translate-y-1 hover:scale-110 hover:bg-green-900 duration-300 text-gray-300 text-md font-bold items-center gap-x-4 
