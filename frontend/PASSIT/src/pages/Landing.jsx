  ...
  return (
    <div className="flex select-none ">
      ...
      >
        ...
        <div className="font-3xl absolute left-12 top-12">
        ...
        <div className="card-swiper absolute top-44">
          <div className="card-group w-96">
            ...
            <div className="big-card card m-0"></div>
            ...
            <div className="big-card card m-0 bg-secondary-content text-primary-content bg-opacity-90">
              <div className="card-body text-center">
                <h2 className="card-title text-2xl">
                  Is <span className="text-secondary">PASSIT</span> for you?
                </h2>
                <p className="text-xl"></p>

                <p className="text-xl">
                  PASSIT comes to up the ante, by providing a platform for
                  coaches, players, and fans to deepen their analysis of the
                  game.
                </p>
                <p className="text-xl">
                  {" "}
                  We make fans <span className="text-accent">learn</span>,
                  coaches <span className="text-accent">strive</span>, players{" "}
                  <span className="text-accent">grow</span>.
                </p>
                <div className="card-actions justify-end">
                  <button
                    className="btn hover:bg-primary-focus rounded-lg border-0"
                    onClick={coursesPage}
                  >
                    Get Started
                  </button>
